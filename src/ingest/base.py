"""Base ingest parser for the Rare Disease Diagnostic Agent.

Defines the abstract BaseIngestParser interface and the IngestRecord dataclass
that all concrete parsers (OMIM, HPO, Orphanet, GeneTherapy) implement.
...
class IngestRecord:
    ...
    Attributes:
        ...
        source: Data source identifier (e.g., "omim", "hpo", "orphanet").
    """
